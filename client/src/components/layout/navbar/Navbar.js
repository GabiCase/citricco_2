    ...
    render() {
        return (
            ...
            <>
                <Navbar bg="light" expand="lg" onClick={() => this.hiddeSuggestion()}>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            <NavDropdown title="Pendientes" id="basic-nav-dropdown" className="earrings">
                                <NavDropdown.Item>
                        ...
                        {this.props.loggedInUser ?
                            this.props.loggedInUser && <Link className="nav-link" to="/account/profile">

                                <NavDropdown className="user-logo transparent" title="" id="basic-nav-dropdown">
                                    <NavDropdown.Item>
                                        <Link className="dropdown-item" to="/account/profile">My profile</Link>
                                    </NavDropdown.Item>

                                    <NavDropdown.Item>
                                        <Link className="dropdown-item" to="account/orderhistory">Order history</Link>
                                    </NavDropdown.Item>

                                    <NavDropdown.Item>
                                        <Link className="dropdown-item" to="account/whislist">My whislist</Link>
                                    </NavDropdown.Item>

                                    <NavDropdown.Item>
                                        <Link className="dropdown-item" to="account/logout" onClick={() => this.logoutUser()}>Logout</Link>
                                    </NavDropdown.Item>

                                </NavDropdown>
                            </Link>
                            :
                            <Link className="nav-link" to="/account/login"><img className="cart-img" src={user} /></Link>}
                ...
                <div>
                    {this.state.showSuggestion && <Suggestions hiddeSuggestion={this.hiddeSuggestion} search={this.state.search} />}
                </div>
            </>
